...
class SynthDriver(synthDriverHandler.SynthDriver):
	...
	def _get_availableSamplerates(self):
		...
		rates["4"] = StringParameterInfo("4", "16 kHz (v21 EQ + 4 kHz, voiced 0 dB)")
		rates["5"] = StringParameterInfo("5", "16 kHz (v21 EQ + 4 kHz, voiced -1 dB)")
		rates["21"] = StringParameterInfo("21", "16 kHz (v21 EQ + 4 kHz, voiced -2 dB)")
		rates["22"] = StringParameterInfo("22", "16 kHz (v21 EQ only, voiced 0 dB)")
		return rates
