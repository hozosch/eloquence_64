...
class SynthDriver(synthDriverHandler.SynthDriver):
	...
	def _get_availableSamplerates(self):
		...
		rates["4"] = StringParameterInfo("4", "16 kHz (upper mids, full sibilance block -6 semitones)")
		rates["5"] = StringParameterInfo("5", "16 kHz (upper mids, full sibilance block -9 semitones)")
		rates["21"] = StringParameterInfo("21", "16 kHz (upper mids, full sibilance block -12 semitones)")
		rates["22"] = StringParameterInfo("22", "16 kHz (full sibilance block -9 semitones, no mid EQ)")
		return rates
