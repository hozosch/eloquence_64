...
_ECI_BASE_RATE_MAP = {
	...
	3: 16000,  # experimental native16 treatment with softer sibilance
}
...
def _prepare_syn_engines(mode):
	...
	try:
		...
		mode = 1
	target_ext = {2: ".p16", 3: ".p16s"}.get(mode)
	...
	labels = {2: "native 16 kHz", 3: "native 16 kHz with softer sibilance"}
...
def set_sample_rate(mode) -> None:
	"""Select 8, 11.025, or one of the native 16 kHz tunings."""
