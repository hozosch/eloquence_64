...
# Preserve the exact v21.2 curve for voiced sibilance and use it for the upper
# stage of a plain unvoiced S. The lower stage keeps the newer 6.8 kHz curve,
# making the unvoiced result a component-level mixture of the two versions.
VOICED_SIBILANCE_FILTER_GAIN_DB = -10.0
VOICED_SIBILANCE_FILTER_MAKEUP_DB = 2.5
...
# Keep the separate English/Chinese voiced-S table exactly at its v21.2
# balance; later body/frication offsets made the consonant sound unnatural.
HISTORICAL_VOICED_S_BODY_GAIN_DB = 0.0
HISTORICAL_VOICED_S_FRICATION_GAIN_DB = 0.0
...
GENERAL_VOICED_FILTER_HELPER_CODE = bytes.fromhex(
	"8b94243001000085d2740983baac00000000754b"
	"83fb11740583fb1275288b542410"
	"83bae400000000753483bae800000000752b"
	"83baec00000000752283baf0000000007519"
	"85c07515"
